...
require (
	...
	github.com/tullo/shippy/shippy-service-user v0.0.0-20221220163433-310173d29dc2
	github.com/tullo/shippy/shippy-service-vessel v0.0.0-20221220163739-e64e1af2dbc0
